...
<%@ page import="com.microsoft.windowsazure.activedirectory.sdk.wsfed.*"%>
	        ...
	        <div id="tabs" style="width:1200px" class="nav-box">
	            ...
	            <div id="tabs-1" style="height:200px">	            	
	            	<aside>
						<ul>
						  <li>
								<a href="<%=com.microsoft.windowsazure.activedirectory.sdk.wsfed.FederatedLoginManager.getFederatedLoginUrl(request.getParameter("returnUrl"))%>">
								<%="login " + com.microsoft.windowsazure.activedirectory.sdk.wsfed.FederatedConfiguration.getInstance().getStsFriendlyName() + " using wsfed"%></a>		  
							</li> 	
						</ul>
					</aside>
